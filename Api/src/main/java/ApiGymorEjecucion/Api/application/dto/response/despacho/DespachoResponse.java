...
public class DespachoResponse {
    ...
    public LocalDateTime getFechaEmisionGuia() { return fechaEmisionGuia; }
    ...
    public String getTelefonoTransportista() { return telefonoTransportista; }
    ...
    public boolean isEstaDespachado() { return estaDespachado; }
    public void setEstaDespachado(boolean estaDespachado) { this.estaDespachado = estaDespachado; }

    public boolean isEstaEntregado() { return estaEntregado; }
    public void setEstaEntregado(boolean estaEntregado) { this.estaEntregado = estaEntregado; }
}